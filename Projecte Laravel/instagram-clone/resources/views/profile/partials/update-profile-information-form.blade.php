<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <x-text-input id="nick" name="nick" type="text" class="mt-1 block w-full" :value="old('nick', $user->nick)" autocomplete="nick" />
        ...
        <div>
            ...
            @if($user->image)
                <div class="mb-4">
                    <p class="text-sm text-gray-600 mb-2">{{ __('Avatar actual') }}</p>
                    <img src="{{ asset('storage/' . $user->image) }}" 
                         class="w-20 h-20 rounded-full object-cover shadow-sm border border-gray-200">
                </div>
            @endif
